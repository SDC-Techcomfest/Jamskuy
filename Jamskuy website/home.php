	...
	<!-- Kategori -->
	<section class="banner p-t-45 p-b-40 m-b-80">
		<div class="container">
	...
	<section class="banner m-b-60 playstore-section m-b-40">
		<div class="container center">
			<div class="row">
				<div class="col-md-8">
					<h2 class="font-bold text-dark2">Beli Jamu Kini Lebih Mudah</h2>
	...
	<!-- New Product -->
	<section class="newproduct p-t-60 p-b-80">
		<div class="container">
	...
	<!-- Testismoni -->
	<section class="testismoni p-t-45 p-b-40 m-b-60">
		<div class="container">
			<div class="sec-title p-b-30">
				<h2 class="t-center">
					kata pembeli
